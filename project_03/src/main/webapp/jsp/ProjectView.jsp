					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								...
								<%
									Map map = (Map) request.getAttribute("categoryy");
								%>
							...
							<div class="md-form">
								...
								<span
									class="pl-sm-5"><b>Version</b> <span style="color: red;">*</span></span>
								</br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="version"
											...
											onblur="validateIntegerInput(this, 'versionError', 2)"
												value="<%=DataUtility.getStringData(dto.getVersion()).equals("0") ? ""
												: DataUtility.getStringData(dto.getVersion())%>">

									</div>
								</div>
								<font color="red" class="pl-sm-5" id="versionError"> <%=ServletUtility.getErrorMessage("version", request)%></font></br>
