			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="quality" placeholder="Enter quality"
						class="form-control"
						oninput="handleLetterInput(this, 'qualityError', 200)"
						onblur="validateLetterInput(this, 'qualityError', 200)"
						
						value="<%=ServletUtility.getParameter("quality", request)%>">

					<font color="red" class="pl-sm-5" id="qualityError"></font>
 ...
 --%>
				...
				<div class="col-sm-2">
					<input type="text" id="datepicker" name="purchesDate"
						class="form-control" placeholder="  Enter purchesDate"
						readonly="readonly"
