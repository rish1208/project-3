				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Employee Job</h3>
							<%
								} else {
							%>
							...
							<div>
								<%
									HashMap map = (HashMap) request.getAttribute("departments");
								%>
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>LastName</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="lastName"
											...
											oninput="handleLetterInput(this, 'lastNameError', 20"
											onblur="validateLetterInput(this, 'lastNameError', 20)"
												value="<%=DataUtility.getStringData(dto.getLastName())%>">
									</div>
								</div>

								<font color="red" class="pl-sm-5" id="lastNameError"> <%=ServletUtility.getErrorMessage("lastName", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList("department", String.valueOf(dto.getDepartment()), map)%>
							...
							<span class="pl-sm-5"><b>DateOfJaining</b> <span
								style="color: red;">*</span></span></br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
									...
									<input type="text" id="datepicker" name="dateOfJaining"
										class="form-control" placeholder="DateOfJaining"
										readonly="readonly"
										value="<%=DataUtility.getDateString(dto.getDateOfJaining())%>">
								</div>
							</div>
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("dateOfJaining", request)%></font></br>
