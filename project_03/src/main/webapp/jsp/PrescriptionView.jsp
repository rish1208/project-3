					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5" id="diseaseError"> <%=ServletUtility.getErrorMessage("disease", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList("capacity", String.valueOf(dto.getDisease()), map)%>
