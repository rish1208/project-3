				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="quality" placeholder="Enter quality"
											class="form-control"
											oninput="handleLetterInput(this, 'qualityError', 100)"
											onblur="validateLetterInput(this, 'qualityError', 100)"
												value="<%=DataUtility.getStringData(dto.getQuality())%>">

									</div>
								</div>

								<font color="red" class="pl-sm-5" id="qualityError"> <%=ServletUtility.getErrorMessage("quality", request)%></font></br>
							...
							<span class="pl-sm-5"><b>PurchesDate</b> <span
								style="color: red;">*</span></span></br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
									...
									<input type="text" id="datepicker" name="purchesDate"
										class="form-control" placeholder="purchesDate"
										readonly="readonly"
										value="<%=DataUtility.getDateString(dto.getPurchesDate())%>">
								</div>
							</div>
