...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.STOCKANALYSIS_LIST_CTL%>" method="post">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="20%" class="text">AnalysisType</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="StockAnalysisCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
