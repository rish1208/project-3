...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.TRANSACTIONS_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.TransactionsDTO"
			...
			<%
				...
				Iterator<TransactionsDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				...
				<center>
					<div class="col-sm-2">
						<input type="submit" class="btn btn-primary btn-md"
							...
							value="<%=TransactionsListCtl.OP_SEARCH%>"> &emsp; <input
							type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
							name="operation" value="<%=TransactionsListCtl.OP_RESET%>">
					</div>
				</center>
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=TransactionsListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=TransactionsListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=TransactionsListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=TransactionsListCtl.OP_NEXT%>"
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=TransactionsListCtl.OP_BACK%>">
				</div>
