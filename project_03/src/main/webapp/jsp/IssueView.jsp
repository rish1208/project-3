					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b> AssinTo</b> <span
									...
									<div class="input-group">
										...
										<input type="text" name="title" placeholder="Enter title"
											...
											onblur="validateLetterInput(this, 'titleError', 200)"
												rows="5" cols="5"><%=DataUtility.getStringData(dto.getTitle())%>

									</div>
								</div>

								<font color="red" class="pl-sm-5" id="titleError">
									<%=ServletUtility.getErrorMessage("title", request)%></font></br> 
