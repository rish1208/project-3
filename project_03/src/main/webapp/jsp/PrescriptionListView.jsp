...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.PRESCRIPTION_LIST_CTL%>" method="post">
			...
			<%
				HashMap map = (HashMap) request.getAttribute("capacityy");
			%>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="disease" placeholder="Enter Disease"
						class="form-control"
						oninput="handleLetterInput(this, 'diseaseError', 25)"
						onblur="validateLetterInput(this, 'diseaseError', 25)"
						value="<%=ServletUtility.getParameter("disease", request)%>">
					<font color="red" class="pl-sm-5" id="diseaseError"></font>

				</div>
				
				<div class="col-sm-2"><%=HTMLUtility.getList("capacity", String.valueOf(dto.getCapacity()), map)%></div>
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=PrescriptionListCtl.OP_BACK%>">
				</div>
