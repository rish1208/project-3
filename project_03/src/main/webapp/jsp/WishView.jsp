				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add WishList</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="userName" placeholder="Enter UserName"
											class="form-control"
											oninput="handleLetterInput(this, 'userNameError', 25)"
											onblur="validateLetterInput(this, 'userNameError', 25)"
								...
								<font color="red" class="pl-sm-5" id="remarkError">
									<%=ServletUtility.getErrorMessage("remark", request)%></font></br> 
