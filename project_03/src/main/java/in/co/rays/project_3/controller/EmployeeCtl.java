...
public class EmployeeCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		map.put("Civil", "Civil");
		map.put("It", "It");
		map.put("Machanical", "Machanical");

		request.setAttribute("departments", map);
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			...
			request.setAttribute("lastName", "lastName must contains alphabets only");
			System.out.println(pass);
			pass = false;
			...
			if (DataValidator.isNull(request.getParameter("department"))) {
				...
				pass = false;
					...
					request.setAttribute("department", "department must contains alphabets only");
					System.out.println(pass);
					pass = false;

				}

			if (DataValidator.isNull(request.getParameter("dateOfJaining"))) {
				request.setAttribute("dateOfJaining", PropertyReader.getValue("error.require", " dateOfJaining"));

				pass = false;
			} else if (!DataValidator.isDate(request.getParameter("dateOfJaining"))) {
				request.setAttribute("dateOfJaining", " dateOfJaining must contains Date only");
				System.out.println(pass);
				pass = false;
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		dto.setDateOfJaining(DataUtility.getDate(request.getParameter("dateOfJaining")));
