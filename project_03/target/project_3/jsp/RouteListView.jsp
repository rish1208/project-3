...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.ROUTE_LIST_CTL%>" method="post">
			...
			<%
				HashMap map = (HashMap) request.getAttribute("routep");
			%>
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Route List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<%
						String htmlList = HTMLUtility.getList("vehicleID", String.valueOf(dto.getVehicleID()), map);
					%>

					<%=htmlList%>
					<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("vehicleID", request)%></font>
				</div>
		...
		<table class="table table-bordered table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">AllowedSpeed</th>
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=RouteListCtl.OP_BACK%>">
		</div>
