						...
						<div class="card-body">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="insuranceAmount"
											...
											oninput="handleIntegerInput(this, 'insuranceAmountError', 3)"
											onblur="validateIntegerInput(this, 'insuranceAmountError', 3)"
								...
								<font color="red" class="pl-sm-5" id="insuranceAmountError">
									<%=ServletUtility.getErrorMessage("insuranceAmountError", request)%></font></br>
